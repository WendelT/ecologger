...
// Establish connection to MySQL database
   ...
   //echo "new version 12";
    //$dt1= "2021-07-27";
       ...
       $sql = "SELECT hms_server AS x, POWER((SPLIT_STRI(dados_list,',', $pos)),1) y FROM tab_final WHERE (id_cliente='".$nm."') AND (date BETWEEN '".$dt1."' AND '".$dt2."') AND (hms_server BETWEEN '".$tm1."' AND '".$tm2."')";
       //$sql = "SELECT hms_log, POWER((SPLIT_STRI(value2,',', $pos)),1) totalEner FROM tab_final WHERE (value1='".$nm."') AND (date BETWEEN '".$dt1."' AND '".$dt2."') AND (hms_log BETWEEN '".$tm1."' AND '".$tm2."')";
