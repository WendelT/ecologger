...
// Establish connection to MySQL database
    ...
    //$dt1= "2021-07-27";
       ...
       $dt2= $_GET["data_final"];
        ...
        $sql = "SELECT DATE(date) as DATE, SUM(SPLIT_STRI(dados_list,',', 2)) totalEner FROM tab_final_copy WHERE (id_cliente='".$nm."') AND (DATE BETWEEN '".$dt1."' AND '".$dt2."' ) GROUP BY DATE(date)";
