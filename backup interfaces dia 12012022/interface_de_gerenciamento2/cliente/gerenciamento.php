...
<html>
    ...
    <!-- Modal -->
    <div id ="addClienteModal" class="modal" id="exampleModal" tabindex="-1" role ="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" id="insert_form">
                            ...
                            <div class="mb-3">
                                <button type="submit" class="btn btn-outline-success" id="cadCliente" name="cadCliente">Cadastrar</button>
                            </div>
                        </form>
                    </div>
                </div>
