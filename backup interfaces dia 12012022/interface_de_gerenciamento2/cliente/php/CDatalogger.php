<?php
    ...
    {
        $nome = filter_input(INPUT_POST, 'nomeLogger', FILTER_SANITIZE_STRING);
        ...
        $insert_usuario  = "INSERT INTO unidade_logger(id_unidade,id_unico,data_inicio,data_fim,status) VALUES ('user','".$login."','".$email."','".$nome."',md5('".$senha."'),NOW(),NOW())";
