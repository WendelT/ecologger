//var url;
      ...
      function savedata() { 
            ...
            switch(pos!=null){
              case pos.value == "dailyTotalEnergy":
                ...
                sessionStorage.setItem("variablePosition", "Ener");
              ...
              case pos.value == "dailyTotalPower":
                ...
                type = "totalPower";
                sessionStorage.setItem("variablePosition", "W_CA");
                sessionStorage.setItem("variableType", type);
      ...
      let url = "http://ecologger.eng.br/interface_de_gerenciamento2/cliente/php/data.php?" +sessionStorage.getItem("urlString") + "&nome=" + sessionStorage.getItem("url1");
          ...
          {
            {
              $.get(url,
                function (data)
                {
                  ...
                  for (var i in data) {
                      if(data[i].y < 5728965 && data[i].y > -5728936){
