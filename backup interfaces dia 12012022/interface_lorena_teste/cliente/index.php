    ...
    <body>
        ...
        <section id="dados">
            ...
            <div class="borda">
                ...
                <p class="infos" > <span id="potInstalada">-</span> kWp</p>
            </div>
            ...
            <div class="borda">
                ...
                <img src="img/economia2.png" alt="economia gerada" width="50" height="50">
                <p class="infos"><span id="ecoGerada">-</span> R$</p>
            </div>

            <div>
                <p  class="titulo">Árvores Cultivadas</p>
                <img src="img/arvore.png" alt="árvores cultivadas" width="50" height="50">
                <p class="infos" ><span id="quantArvores">-</span></p>
            </div>
        ...
        <div id="grafico">
            <div class="cgrafico">
            <form class="form" name="myForm" method="post" onsubmit="return savedata()">
                ...
                <input type="submit" id="update" class="filter" name="submit" value="FILTRAR" />
            </form>
