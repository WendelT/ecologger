...
<html>
    ...
    <body>
       ...
       <!-- <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"> </button> -->
        ...
        <!-- Modal -->
        <div id ="addUnidadeModal" class="modal fade" id="exampleModal" tabindex="-1" role ="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <form method="POST" id="insert_form">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="estadoUnidade" type="text" class="form-control" id="estadoUnidade" placeholder="Estado">
                            </div>
                            <div class="mb-3">
