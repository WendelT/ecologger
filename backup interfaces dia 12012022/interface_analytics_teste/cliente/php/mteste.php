...
if ($type == 'totalPower') {
    ...
    $invs = "SELECT DISTINCT id_inv, dados_list as dados FROM tab_final t1 WHERE date = '".$dt1."' AND id_inv IN (SELECT id_inv FROM tab_final WHERE id_unico IN (SELECT id_unico FROM unidade_logger WHERE id_unidade='" . $nm . "')) GROUP BY id_inv";
