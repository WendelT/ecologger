    ...
    <body>
        <nav>
            ...
            <ul>
                ...
                <li>
                    <a href="#" class ="material-icons">show_chart</a>
                </li>
                <li>
        ...
        <section id="grafico">
            <div id="infos1">
                ...
                <div class="status">
                    <div class="dados">
                    <p>Status</p>
                    <span>(Retornar se online ou offline) </span>
                </div> 
                ...
                <div class="arvores"> 
                    ...
                    <span>(retornar arvores cultivadas)</span>
                </div>
            ...
            <div id="infos2">
              ...
              <div class="potencias">
                  ...
                  <div class="dados">
                <p>Usina (kWp)</p>
                <span>(retornar Potência da Usina (kWp))</span>
            </div>
            ...
            <div class="producao">
                <div class="dados">
                <p>Produção (kWh)</p>
                <span>(retornar Produção (kWh))</span>
            </div>
            ...
            <div class="instantanea">
                <div class="dados">
                <p>Instantânea</p>
                <span>(retornar Potência Instantânea)</span>
            </div>
