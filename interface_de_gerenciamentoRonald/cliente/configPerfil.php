...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/configPerfil.js"></script>
        ...
        <form action="php/configPerfilQuery.php" method="POST">
            ...
            <div class="cardPerfil">
                ...
                <div class="dados">
                    ...
                    <input class="campo" name="nome" type="password" placeholder="Senha do Cliente" id="novaSenha">
                </div>

                <div class="dados">
                    <p class="infos">Confirmação de senha</p>
                    <input class="campo" name="nome" type="text" placeholder="Confirmação de Senha do Cliente" id="novaSenhaConf">
                </div>
